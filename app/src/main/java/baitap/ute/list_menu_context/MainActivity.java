package baitap.ute.list_menu_context;
...
////    }
    ...
    private void populateCountriesData() {
        ...
        countriesModel.setName("Phim Ma");
        countriesModel.setImage(R.drawable.ma);
        ...
        countriesModel.setName("Phim tài liệu");
        ...
        countriesModel.setName("Hài");
        countriesModel.setImage(R.drawable.hai);
        ...
        countriesModel.setName("Phim bom tấn");
        countriesModel.setImage(R.drawable.bomtan);
        ...
        countriesModel.setImage(R.drawable.tinhcam);
        ...
        countriesModel.setName("Phim trinh thám");
        countriesModel.setImage(R.drawable.trinhtham);
